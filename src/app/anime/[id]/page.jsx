  ...
  return (
    <>
      ...
      <div className="p-4 flex gap-2 text-color-primary overflow-x-auto">
        <div className="w-36 flex flex-col justify-center items-center rounded border border-color-primary p-2 hover:bg-color-accent transition-all hover:scale-105">
          <h3>PERINGKAT</h3>
          <p>{anime.data.rank}</p>
        </div>
